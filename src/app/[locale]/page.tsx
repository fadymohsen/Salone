          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 pb-10 border-b border-white/8">
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <div className="flex flex-col gap-2">
                <a href="https://wa.me/201000000000" className="inline-flex items-center gap-2 bg-green-600/90 hover:bg-green-500 text-white text-xs font-semibold px-4 py-2.5 rounded-full transition-colors duration-150 cursor-pointer w-fit" aria-label={t.common.whatsappUs}>
